...
export function PlantSelect(){
    ...
    async function fetchPlants() {
        const { data } = await api.get(`plants?-sort=name&_order=asc&page=${page}&_limit=10`)
        ...
        <View style={styles.container}>
            ...
            <View style={styles.plants}>
                <FlatList 
                    ...
                    // onEndReached={({ distanceFromEnd }) => handleFetchMore(distanceFromEnd)} // Pra ficar sempre gerando listas.
                />
            </View>
